...
class FinalFileDeleteAdapter(
    private val filesToDelete: List<FinalDetails>
) : RecyclerView.Adapter<FinalFileDeleteAdapter.FileDeleteViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FileDeleteViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.fi_del_item, parent, false)
